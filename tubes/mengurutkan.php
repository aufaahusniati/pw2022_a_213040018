        ...
        <div class="container-urutan">
            <div class="col d-inline-flex">
                <div class="input-group me-3 mt-3">
                    <button class="btn btn-success btn-outline dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="bi bi-sort-up-alt"></i>&nbsp;</button>
                ...
                <button class="btn btn-success btn-outline dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="bi bi-sort-down"></i>&nbsp;</button>
                    <ul class="dropdown-menu">
